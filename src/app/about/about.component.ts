...
export class AboutComponent {
  ...
  work: Array<any> = [
    {
      id: 1,
      company: "Nodeprix Technology",
      position: "Python Full-Stack Developer",
      time_period: "January 2025 - July 2025",
      place: "Ahmedabad Gujarat India",
      overview: "NodePrix Technology LLP is a modern IT solutions studio delivering fast, secure, and scalable digital products for startups, enterprises, and global SMBs. We specialize in crafting innovative software solutions that merge clean UI/UX design with robust backend engineering, helping businesses stay ahead in today’s digital-first world.",
      my_role: "Passionate Python Full-Stack Developer with hands-on expertise in building scalable web applications and cloud-based solutions. Skilled in Python, Django, React, and MySQL, with proven experience designing and deploying robust systems that optimize performance and user experience.",
      impact: "Proficient in developing end-to-end ERP systems, copy trading platforms, and eCommerce solutions, leveraging deep understanding of backend architecture, API authentication, and database optimization. Adept at transforming complex business needs into scalable technical solutions.",
      projects: [
        {
  ...
  education: Array<any> = [
    {
      studied_at: "Parul University Vadodara",
      qualified: "B.TECH - Information Technology",
